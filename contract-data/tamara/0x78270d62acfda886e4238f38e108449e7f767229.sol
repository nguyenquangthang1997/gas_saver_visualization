...
contract EIP20Factory {
    ...
    returns (address) {
        ...
        UniversalAidCoin newToken = (new UniversalAidCoin(_initialAmount, _name, _decimals, _symbol));
...
contract UniversalAidCoin is EIP20Interface {
