...
/*
    ...
    The contract will pay out 2 ETH to the first finder of a collision in MiMC at security level of
    80 bits, if such a collision is discovered before the end of March 2020.
...
contract STARK_Friendly_Hash_Challenge_MiMC_80 is Base, Sponge {
