...
/*
    ...
    The contract will pay out 4 ETH to the first finder of a collision in GMiMC_erf with rate 8
    and capacity 4 at security level of 128 bits, if such a collision is discovered before the end
    of March 2020.
...
contract STARK_Friendly_Hash_Challenge_GMiMC_erf_S128d is Base, Sponge {
