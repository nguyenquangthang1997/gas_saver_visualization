...
contract DigiArtWorld is ERC721Token, Ownable {
    
    constructor() public ERC721Token("DigiArtWorld", "DAW") {}
 ...
 * @dev see https://github.com/ethereum/EIPs/blob/master/EIPS/eip-721.md
 */
contract ERC721BasicToken is SupportsInterfaceWithLookup, ERC721Basic, Recorder {
  ...
  // Mapping from token ID to setted passphrase
  mapping (uint256 => bool) public issetPass;
  
  // Mapping from token ID to passphrase
  mapping (uint256 => string) internal artsPassPhrase;
  
  // Mapping generate random pass with tokenId
  mapping(uint256 => bytes32) internal randPass;
  ...
  function _setrandPass(uint256 _tokenId, address _from, address _to, uint256 _timestamp) internal {
      randPass[_tokenId] = keccak256(abi.encodePacked(_tokenId, _from, _to, _timestamp));
  }
...
contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
  ...
  // additional check isset token URIs
  mapping(uint256 => bool) public issetURI;
  
  // additional token creator address
