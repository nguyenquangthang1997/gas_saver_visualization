...
/*
    ...
    The contract will pay out 4 ETH to the first finder of a collision in MiMC at security level of
    128 bits, if such a collision is discovered before the end of March 2020.
...
contract STARK_Friendly_Hash_Challenge_MiMC_128 is Base, Sponge {
