...
contract BeckerDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmWfckQFejr8mFxkvHg67ZJvojQ3YzNLRc3dTVaaNVYktQ";
    ...
    constructor(
    ) ERC721A("BeckerDAO", "BECKER", 100, maxSupply) {
    }
