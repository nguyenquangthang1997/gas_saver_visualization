...
contract ShinjTama  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "ShinjTama";                                          
    string private _symbol = "$SHJTMA";                                           
    ...
    address payable public marketingWallet = payable(0xD11Fde82730Be1ff986c47a93534692aBaBdCdb7);
