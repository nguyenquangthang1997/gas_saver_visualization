...
contract BellaPoarchDAO is ERC721A, Ownable {
   uint256 public NFT_PRICE = 0.01 ether;
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
      ...
      if (!IS_REVEALED) {
        string memory uri_start = "{\"description\": \"BellaPoarch DAO is dedicated towards empowering up and coming tiktok stars and fighting against the stigmas online and trolls that target dance creators. We will specifically support Bella in her endeavors and host community fan events. \", \"image\": \"ipfs://QmUDz7cuFczYeCgCh5Eo3LSG3TdZDHm7zR2JVw9afGpJhi \", \"name\": \"BellaPoarchDAO Pass #";
        string memory uri_end = "\", \"attributes\": [{\"trait_type\": \"Status\", \"value\": \"Unrevealed\"}]}";
        return string(abi.encodePacked(uri_start, tokenId.toString(),uri_end));
      }
