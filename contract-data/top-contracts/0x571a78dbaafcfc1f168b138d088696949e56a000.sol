...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
        ...
        returns (uint256 tokenId)
    {
        require(
            ...
            "ERC721Enumerable: Index exceeds balance of owner."
        );
        uint256 count;
        ...
        require(false, "ERC721Enumerable: Index exceeds balance of owner.");
    }
    ...
    {
        require(0 < ERC721.balanceOf(owner), "ERC721Enumerable: Owner owns no tokens.");
        ...
        returns (uint256)
    {
        require(
            ...
            "ERC721Enumerable: Index exceeds total supply."
        );
        return index;
    }
}
...
abstract contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
        ...
        returns (uint256)
    {
        require(
            owner != address(0),
            "ERC721: Cannot query balance for zero address."
        );
        uint256 count = 0;
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        ...
        require(to != owner, "ERC721: Cannot approve current owner.");
        ...
        returns (address)
    {
        require(
            _exists(tokenId),
            "ERC721: Approval query for non-existent token."
        );
    ...
    function setApprovalForAll(address operator, bool approved)
        ...
        override
    {
        require(operator != _msgSender(), "ERC721: Cannot approve to caller.");
        ...
        returns (bool)
    {
        require(
            _exists(tokenId),
            "ERC721: Query for non-existent token."
        );
        address owner = ERC721.ownerOf(tokenId);
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        require(!_exists(tokenId), "ERC721: Token ID has already been minted.");
    ...
    function _transfer(
        ...
        require(
            ...
            "ERC721: Caller does not own token."
        );
    ...
    function _checkOnERC721Received(
        ...
        if (to.isContract()) {
            ...
            returns (bytes4 retval) {
                ...
                if (reason.length == 0) {
                    revert(
                        "ERC721: Recipient is not an ERC721Receiver."
                    );
                } else {
                    assembly {
