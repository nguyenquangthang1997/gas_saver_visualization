...
contract FirstClassTaz is ERC721, Ownable {
    using Strings for uint256;
    using Counters for Counters.Counter;

    Counters.Counter private _totalSupply;
    uint256 private _presaleSupply = 0;
    ...
    uint256 public preSaleDate = 1642971600;
    uint256 public preSaleEndDate = 1643058000;
    uint256 public publicSaleDate = 1643144400;
    ...
    address public wallet1 = 0x64231DB161C803ABcaA948821a06F35Ed5F02C20;
    address public wallet2 = 0x379e7CC29d36a45F85D8393FB83614D2A60B4f30;
    address public wallet3 = 0x9648c97e4372b13Ff532091F5d5aCdeDA85CE9eC;

    constructor(string memory _initNotRevealedUri) ERC721("First Class Taz", "FCT") {
    ...
    // PRESALE MINT
    function presaleMint(uint256 _mintAmount, bytes32[] calldata _proof) public payable notPaused presaleStarted minimumMintAmount(_mintAmount) {
        uint256 supply = totalSupply();
        uint256 ownerMintedCount = addressMintedBalance[msg.sender];

        require(block.timestamp <= preSaleEndDate, "presale is finished");
        require(ownerMintedCount + _mintAmount <= nftPerAddressLimitPresale, "max NFT per address exceeded for presale");
        ...
        require(_presaleSupply + _mintAmount <= preSaleMaxSupply,"max NFT presale limit exceeded");
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 amount1 = (balance * 0.2 ether) / 1 ether;
        uint256 amount2 = (balance * 0.05 ether) / 1 ether;
        uint256 amount3 = (balance * 0.25 ether) / 1 ether;
        uint256 amount4 = balance - amount1 - amount2 - amount3;
