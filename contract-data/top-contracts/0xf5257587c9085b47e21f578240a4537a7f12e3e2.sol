// SMINEM THE SAVIOR OFFICIAL LINKS:
...
contract ERC20 is IERC20 {
    uint256 internal _totalSupply = 1234567890;
    string _name;
    string _symbol;
...
abstract contract TradableErc20 is MaxBuyDynamic {
    ...
    uint256 public tax24HoursPercent = 20;
        ...
        returns (uint256)
    {
        // get taxes
        uint256 dev = amount / 20; // 5%
        uint256 burn = getSellBurnCount(account, amount); // burn count
