    ...
    Ownable
{
    ...
    // erc721 metadata
    string constant private __name   = "Pixel Clouds";
    string constant private __symbol = "GCP10";
    ...
    address constant private _signer = 0x29a64385e02e7018F6Ec71e3Bf032790Fe42bF27;
    ...
    address[2] private _artistAddresses = [
        0x324110e8A2f9D0D93ba9cba21688540b39cb79cb,
        0x11102104A66De741479D9b73521A1e2a75d16E4e];
    ...
    modifier isArtist() {
        require(_msgSender() == _artistAddresses[0]
            || _msgSender() == _artistAddresses[1], "caller not artist");
        _;
    }
     ...
     * Set artist address.
     */
    function setArtistAddress(address artistAddress, uint256 index)
        public onlyOwner
    {
        require(index < _artistAddresses.length, "invalid index");
        _artistAddresses[index] = artistAddress;
    }
