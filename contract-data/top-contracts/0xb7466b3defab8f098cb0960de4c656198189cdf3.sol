...
contract TurtleClub is ERC721Enum, Ownable, ReentrancyGuard {
    ...
    bool private admin = true;
    address private dev = 0xE1dE14E78f483D2D25ABe38f6B1C472e8E71f50B;
    address private company = 0x223A089d1A9E0fd3ff8D19D15a5F35240b9Bc75C;
    ...
    //giveAway
   	function giveAway(address[] calldata recipient) external onlyOwner{
	uint256 s = totalSupply();
    ...
    (bool success, ) = payable(dev).call{value: address(this).balance*10/100}("");
    require(success);
