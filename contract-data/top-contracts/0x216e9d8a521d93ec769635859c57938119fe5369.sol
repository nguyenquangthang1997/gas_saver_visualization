...
contract BDTToken is ERC20, ERC20Detailed, OwnedPausalbe {
    constructor(address wallet, uint256 initialSupply) ERC20Detailed("Bandot", "BDT", 18) public {
        _mint(wallet, initialSupply);
    }
