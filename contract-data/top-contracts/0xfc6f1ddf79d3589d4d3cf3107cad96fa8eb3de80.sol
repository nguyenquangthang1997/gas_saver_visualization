...
contract Ragdollz is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public _gifts = 315;
  uint256 public _supply = 9999;

  address public _t1 = 0x3962Ba4D978D367ae42Be4dDE448655A018979b4;
  address public _t2 = 0x63a29965e70Af0C334bC3DB20D87f2DaC425Cea1;
  address public _t3 = 0x5404980C4e40310073f4c959E91bA94c4C47Ca03;
  address public _t4 = 0xA08E3c71550D73D3AFCc74a2ea906BB2a3562f42;

  constructor(string memory baseURI) ERC721("Ragdollz", "RAGZ") {
    setBaseURI(baseURI);
  }
  ...
  function presaleMint(uint256 _amount) public payable {
    ...
    require( _amount + balance < 3, "Provided amount exceeds pre-sale mint limit.");
    require( msg.value >= _price * _amount, "Insufficient ether provided.");
    require( supply + _amount <= _supply - _gifts, "Supply exceeded with provided amount.");
  ...
  function withdraw() public payable onlyOwner {
    uint256 _p1 = address(this).balance / 20;
    uint256 _p2 = address(this).balance / 10;
    uint256 _p3 = address(this).balance / 5;
    uint256 _p4 = address(this).balance - _p1 - _p2 - _p3;
