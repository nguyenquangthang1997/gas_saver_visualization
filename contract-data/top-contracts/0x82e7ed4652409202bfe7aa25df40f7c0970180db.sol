...
contract FloNinja  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "FloNinja";                                          
    string private _symbol = "$FLONINJA";                                           
    ...
    address payable public marketingWallet = payable(0x81D53a5a496679f37Eb20F9Dd2d6F1E2566D4C47);
