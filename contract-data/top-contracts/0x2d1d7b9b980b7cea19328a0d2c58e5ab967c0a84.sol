...
contract CCGC is ERC721, Ownable {

    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public SALE_START_TIMESTAMP = 1628512122; // 1628531970

    uint256 public constant MAX_SUPPLY = 5555;

    uint256 public constant MAX_RESERVE = 80;
    ...
    // rename base uri from centralized api to ipfs after sold out
    function renameBaseURI(string memory baseURI) onlyOwner public {
       _setBaseURI(baseURI);
    }
