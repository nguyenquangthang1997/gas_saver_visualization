...
// File @openzeppelin/contracts/token/ERC1155/IERC1155.sol@v4.4.1
...
// File @openzeppelin/contracts/token/ERC1155/IERC1155Receiver.sol@v4.4.1
...
// File @openzeppelin/contracts/token/ERC1155/extensions/IERC1155MetadataURI.sol@v4.4.1
...
// File @openzeppelin/contracts/token/ERC1155/ERC1155.sol@v4.4.1
...
// File contracts/AlphaNode.sol

// MIT
pragma solidity ^0.8.4;
contract AlphaNode is ERC1155, Ownable {
    string public name = "Alpha Node";
    string public symbol = "WMAN";
    uint256 public maxSupply = 1000;
    uint256 public price = 0.1 ether;

    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmXDpd31RQNdEM19oLvQLvcnKfeBwRt9kX6VZDifxY7vtW";
    mapping (uint256 => bool) mintedTokens;
    uint256 totalMinted = 0;

    ERC721Enumerable WhaleContract = ERC721Enumerable(0xA87121eDa32661C0c178f06F8b44F12f80ae4E88); // Mainnet
    
    event TokenMinted(address to, uint256[] amount);
    
    constructor() ERC1155("https://gateway.pinata.cloud/ipfs/QmXDpd31RQNdEM19oLvQLvcnKfeBwRt9kX6VZDifxY7vtW") {}
    ...
    function uri(uint256 tokenId) override public view returns (string memory) {
        require(mintedTokens[tokenId], "NOT_EXISTED_TOKEN");
        return (
    ...
    function totalSupply() public view returns(uint256) {
        return WhaleContract.totalSupply();
    }
