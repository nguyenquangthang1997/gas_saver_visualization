...
contract FantasyWorldGold is Context, IERC20, Ownable {
    ...
    constructor () {
        _name = "Fantasy World Gold";
        _symbol = "FWG";
        _decimals = 9;
        _tTotal = 1000000000 * 10**_decimals;
        _rTotal = (MAX - (MAX % _tTotal));
        
        marketingAddress = payable(0xce39b2dFb7aE928A2C9801A23d7ed423356258b0);
        ...
        _liquidityFee = buybackFee + marketingFee;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(marketingAddress, transferredBalance.div(_liquidityFee).mul(marketingFee));        
    }
