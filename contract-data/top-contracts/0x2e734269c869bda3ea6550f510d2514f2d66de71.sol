...
import './oz/contracts/token/ERC1155/ERC1155Burnable.sol';
import './oz/contracts/token/ERC1155/ERC1155Pausable.sol';

contract StrongNFTV2 is Context, AccessControl, Ownable, ERC1155Burnable, ERC1155Pausable {
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
  ...
  function _mint(
    ...
    if (!_ownerIdExists(account, id)) {
      _addOwnerId(account, id);
    }
  ...
  function _mintBatch(
    ...
    for (uint256 i = 0; i < ids.length; i++) {
      ...
      if (!_ownerIdExists(to, ids[i])) {
        _addOwnerId(to, ids[i]);
      }
    }
  ...
  function _burn(
    ...
    if (_balances[id][account] == 0 && _ownerIdExists(account, id)) {
      _deleteOwnerId(account, id);
    }
  ...
  function _burnBatch(
    ...
    for (uint256 i = 0; i < ids.length; i++) {
      ...
      if (_balances[ids[i]][account] == 0 && _ownerIdExists(account, ids[i])) {
        _deleteOwnerId(account, ids[i]);
      }
    }
