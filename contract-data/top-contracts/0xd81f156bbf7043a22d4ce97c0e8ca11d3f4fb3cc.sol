...
contract Map is ERC721Enumerable, ReentrancyGuard, Ownable {
    constructor() ERC721("Maps", "MAP") {}
    ...
    /// @notice Discovers a map (mints a token)
    /// @param tokenId the token ID
    function discoverMap(uint256 tokenId) public nonReentrant {
