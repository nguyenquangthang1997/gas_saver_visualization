...
// File: The Planet of Hares/ThePlanetOfHares.sol
...
contract ThePlanetOfHares is ERC721Enumerable, Ownable {
    using Address for address;
    using Strings for uint256;
    ...
    uint256 public constant NFT_PRICE_PRESALE = 60000000000000000; // 0.06 ETH
    uint256 public constant NFT_PRICE = 80000000000000000; // 0.08 ETH

    uint256 public constant MIN_NFT_PURCHASE_PRESALE = 10;
    uint256 public constant MAX_NFT_PURCHASE_PRESALE = 50;

    uint256 public constant MIN_NFT_PURCHASE = 1;
    ...
    constructor(address _multiSigWallet) ERC721("The Planet of Hares","HARES") {
        multiSigWallet = _multiSigWallet;
    }

    function withdraw(uint256 _amount, address payable _recipient) public OnlyMultiSignWallet {
        uint balance = address(this).balance;
        require(_amount <= balance, 'Not enough ether left');
    ...
    function flipPresaleStateAndSaleState() public onlyOwner {
        presaleIsActive = !presaleIsActive;
        saleIsActive = !saleIsActive;
    }
    ...
    function mintHarePresale(uint numberOfTokens) public payable {
        require(presaleIsActive, "Presale is not active at the moment");
        require(numberOfTokens >= MIN_NFT_PURCHASE_PRESALE, "Number of tokens can not be less than 10");
        require(numberOfTokens <= MAX_NFT_PURCHASE_PRESALE, "Number of tokens can not be more than 30");
    ...
    function mintHare(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens >= MIN_NFT_PURCHASE, "Number of tokens can not be less than 1");
        require(numberOfTokens <= MAX_NFT_PURCHASE, "Number of tokens can not be more than 10");
