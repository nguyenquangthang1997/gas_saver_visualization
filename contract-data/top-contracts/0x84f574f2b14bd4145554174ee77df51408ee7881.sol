...
contract Spacelings is ERC721, Ownable {
	using Counters
	...
	string public CURR_ROUND_PASSWORD = "6654513c7d09a78f899a4ece07ad7e5f";
	uint public CURR_ROUND_SUPPLY = 1000;
	uint public CURR_ROUND_TIME = 1640896200000;
	
	uint public maxMintAmount = 8;
	...
	constructor() ERC721("Spacelings", "Spacelings") {
		setBaseURI("http://api.spacelings.club/spacelings/");
	}
