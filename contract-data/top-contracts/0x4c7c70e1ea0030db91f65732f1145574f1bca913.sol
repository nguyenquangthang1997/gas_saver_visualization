/**
Okuri Inu is a type of yokai and its literal meaning is 'escorting dog'. Traditionally, it is a wolf that closely stalks people walking along mountain paths at nighttime. It relies on true stealth to attack its victims, lurking in the shadows and waiting for the perfect time to pounce.

https://okurinu.com/
https://t.me/okurinu_portal
https://twitter.com/Okuri_eth
...
contract OkuriInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "OkuriInu";//
    ...
    address payable private _developmentAddress = payable(0x029e5646A6f125D9ad3f720481c5366377E2bed5);//
    address payable private _marketingAddress = payable(0x3B99E674e76f78F14ad645Bac46A3052261758e9);//
