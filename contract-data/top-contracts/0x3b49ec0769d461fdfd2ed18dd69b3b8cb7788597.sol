/**
 *Submitted for verification at Etherscan.io on 24/09/2021
*/
 ...
 */
contract MonsterMash is ERC721, Ownable {
    using SafeMath for uint256;
   ...
   uint256 public allowListMaxReserve = 50;
    
    mapping(address => bool) private _allowList;
    mapping(address => uint256) private _allowListClaimed;
    

    constructor(string memory baseURI) ERC721("MonsterMash","MM")  {
        setBaseURI(baseURI);
    }
