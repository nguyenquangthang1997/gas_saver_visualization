...
contract Lobby is Context, IERC20, Ownable {
    ...
    string private _name = "Lobby";
    string private _symbol = "LBY";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public charityFeePercent = 4;
    ...
    uint256 public _maxTxAmount = 1000000 * 10**3 * 10**9;
    ...
    function setCharityFeePercent(uint256 fee) public onlyOwner {
        require(fee < 50, "Charity fee cannot be more than 50% of liquidity");
        charityFeePercent = fee;
    }
