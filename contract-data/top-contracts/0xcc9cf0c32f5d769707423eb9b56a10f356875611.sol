...
contract FengShuiDrivers is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    using Strings for uint256;

    address payable private _PaymentAddress = payable(0x76e1B7EFEB27cb927aCBe469E4DFFc031038120a);

    uint256 public FSD_MAX = 7777;
    uint256 private PRESALE_PRICE = 0.095 ether;
    uint256 private PUBLIC_PRICE = 0.14 ether;
    uint256 private REVEAL_DELAY = 72 hours;
    uint256 private PRESALE_HOURS = 48 hours;
    uint256 private PURCHASE_LIMIT = FSD_MAX;
    uint256 private PRESALE_MINT_LIMIT = FSD_MAX;
    uint256 private PUBLIC_MINT_LIMIT = FSD_MAX;
    ...
    uint256 private _activeDateTime = 1643896800; // (GMT): Thursday, February 3, 2022 2:00:00 PM
    
    string private _tokenBaseURI = "";
    string private _revealURI = "";
    
    Counters.Counter private _publicFSD;

    constructor() ERC721("Feng Shui Drivers", "FSD") {}
    ...
    function purchase(uint256 numberOfTokens) external payable {
        require(_publicFSD.current() < FSD_MAX,"Purchase would exceed FSD_MAX");
        ...
        if (msg.sender != owner()) {
            ...
            _PaymentAddress.transfer(msg.value * 97 / 100);
        }
