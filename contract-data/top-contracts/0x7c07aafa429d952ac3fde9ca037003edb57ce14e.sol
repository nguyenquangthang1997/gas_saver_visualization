...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    */
    ...
    function _mint2(address to, uint256 tokenId) internal virtual {
...
contract NonFungibleToken is Context, AccessControl, ERC721Burnable, ERC721Pausable {
    ...
    function setMaxPerWallet(uint256 _max) public virtual {
    ...
    function mintOwner() public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "NonFungibleToken: must have minter role to mint");
        require(treasury < 7, "All treasury NFTs have been minted");
        for(uint i = 0; i < nftPerCall; i++){
            _mint(msg.sender, _tokenIdTracker.current() +1);
            // _holderTokens[msg.sender].add( _tokenIdTracker.current() +1);

            //_tokenOwners.set(tokenId, to);
            _tokenIdTracker.increment();
        }
        treasury = treasury.add(1);
