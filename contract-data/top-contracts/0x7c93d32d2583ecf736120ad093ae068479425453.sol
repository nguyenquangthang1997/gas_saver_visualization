...
contract MicroWorlds is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public constant MAX_WORLDS = 10000;
    uint256 public constant MAX_PURCHASE = 10;

    uint256 public PRICE_PER_WORLD = 50000000000000000 wei;
    ...
    constructor() ERC721("MicroWorlds", "WORLD") { }
    ...
    function mint(uint16 numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_WORLDS, "Insufficient supply");
        require(PRICE_PER_WORLD.mul(numberOfTokens) == msg.value, "Ether value sent is incorrect");
    ...
    /**
     * Reserve a few MicroWorlds for Marketing/Community Engagement
     */
