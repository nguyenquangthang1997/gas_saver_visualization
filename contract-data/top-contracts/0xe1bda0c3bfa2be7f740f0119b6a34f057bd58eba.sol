...
/*
 * Winkies is the ERC20 token for the Winki platform. It is received and
...
contract Winkies is ERC20Capped, Ownable {
    ...
    function claimOffchainGrant(
        ...
        require(validity <= block.number, "Winki: too early");
        require(!nonceUsed[from][nonce], "Winki: nonce already used");
