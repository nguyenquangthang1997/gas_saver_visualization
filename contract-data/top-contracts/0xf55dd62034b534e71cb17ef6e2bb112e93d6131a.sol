...
// File contracts/HiddenInNoise.sol
...
contract HiddenInNoise is ERC721, Ownable, ERC721Enumerable, ReentrancyGuard {
    uint256 public constant MAX_AMOUNT = 1024;
    uint256 public constant PRICE = 0.404 ether;
    ...
    function mintToken() public payable nonReentrant
    {
        ...
        require(PRICE <= msg.value, "Ether value is too small");
