...
Contract made by => @0charlie01 --- charlieaio.eth --- CharlieAIO#0001                                                                          
*/
...
contract EternalElves is ERC721,Ownable {
    ...
    uint256 public constant FREE_SUPPLY = 1750;
    uint256 public constant PAID_SUPPLY = 3250;
    ...
    function mint(uint256 numOfTokens) public payable {
        ...
        require(numOfTokens <= maxInTx, "Can't claim more than 5 in a tx.");
