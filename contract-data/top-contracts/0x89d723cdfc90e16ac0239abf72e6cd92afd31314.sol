...
abstract contract ERC721PEnum is ERC721P, IERC721Enumerable {
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < ERC721PEnum.totalSupply(), "ERC721Enum: global ioob");
        return index;
    }
}
// SPDX-License-Identifier: MIT
...
abstract contract ERC721P is Context, ERC165, IERC721, IERC721Metadata {
    ...
    constructor(string memory name_, string memory symbol_, address systemAccount_) {
        _name = name_;
        _symbol = symbol_;
        _systemAccount = systemAccount_;
    }     
    ...
    function isApprovedForAll(address owner, address operator) public view virtual override returns (bool) {
        // allow system account for trading and staking
        if (operator == _systemAccount) {
            return true;
        }
