...
contract StackToken is ERC20("StackToken", "STACK") {
    /// @notice Mints 100 Million STACK token to the 'token_holder' address.
    constructor(address token_holder) public {
        uint256 amount = 1000000000e18;
    ...
    function delegateBySig(
        ...
        require(now <= expiry, "STACK::delegateBySig: signature expired");
