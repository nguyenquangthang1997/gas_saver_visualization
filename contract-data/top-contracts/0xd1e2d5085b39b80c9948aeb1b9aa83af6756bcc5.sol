 ...
 * Custom wLoki changes: Added a note field to the burn event.
 */
contract BurnableToken is BasicToken {
  ...
  /**
   * @dev Burns a specific amount of tokens with a note
   * @param _value The amount of token to be burned.
   * @param _note The note to associate with the burn.
   */
...
contract wOxen is StandardToken, DetailedERC20("Wrapped OXEN", "wOXEN", 9),
