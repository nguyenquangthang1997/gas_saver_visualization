...
contract Duck458 is Context, IERC20, Ownable {
    ...
    address public marketingWallet = payable(0xe41d00474CbFf3a290Bb53fba9cE4ac8F64CE32C);

    string private _name = "Duck458";
    string private _symbol = "DUCK458";
    ...
    uint256 public _maxTxAmount = 1300000 * 10**9;
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount >= 100000, "Please check threshold amount, should exceed 0.1% of the supply");
