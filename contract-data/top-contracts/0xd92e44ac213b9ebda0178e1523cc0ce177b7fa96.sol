...
contract BeepleCollectionTwoOpenEdition is ERC721Full {
...
//   mapping (uint => bool) public _IPFSHashHasBeenSet;
   ...
   constructor(
       string memory base_uri) ERC721Full("Beeple Round 2 Open Edition", "BEEPLE2") public {
       ...
       //3 open editions
       _numNiftyPermitted[1] = 9999;
       _numNiftyPermitted[2] = 9999;
       _numNiftyPermitted[3] = 9999;
       
       //set names
       _setNiftyTypeName(1, "BULL RUN");
       _setNiftyTypeName(2, "INFECTED");
       _setNiftyTypeName(3, "INTO THE ETHER");
