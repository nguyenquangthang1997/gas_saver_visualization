...
contract SHINJOKI is IERC20, Context, ERC20Ownable {
    ...
    string private constant _names = "SHINJOKI";
    string private constant _symbols = "SHINJOKI";
    ...
    uint8 private _liqTax = 3; 
    uint8 private _previousLiqTax = _liqTax;
    uint8 private _devTax = 5; 
    ...
    address payable private ownAddress;
    ...
    constructor() {
        ...
        feeWallet = payable(0x13b3759B5dEe21991b5C9D43d677cE9b1480baea);
        ownAddress = payable(owner());
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        require(amount > 0);
		require(!_isBot[from]);
		require(!boughtEarly[from] || earlyBuyPenaltyEnd <= block.timestamp);
