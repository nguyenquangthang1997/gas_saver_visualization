...
contract VAPESNFT is ERC721, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmU1vGFDUAMyEHzYZeryE7EDb3Le4U4UW9MKXKFawWXpvP";
    ...
    constructor(
    ) ERC721("VAPES - Vertically Flipped Apes", "VAPES") {
    }
