...
contract TiggerDAOCapital is Context, IERC20, Ownable {
    ...
    uint256 public _tokensFeeFirst2Days = 24; //sell only
    ...
    string private constant _name = "Tigger DAO Capital";
    string private constant _symbol = "$TDC";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xB5Cac05E43F65E565e7AB56bC0F441a2578dE7e9);
        _feeAddrWallet2 = payable(0x47F6ae9D20e5f24792D4b4F0F0479207fEd8d7A0);
        _liquidityWallet = payable(0xeaB41F3a770478D219Bf2F53A628F4140340C497);
        ...
        if (from != owner() && to != owner()) {
            ...
            if (swapAmount > 0 &&
                ...
                if(contractETHBalance > 0) {
                    sendETHToFee(contractETHBalance.mul(5).div(7));
                    sendETHToLiquiityWallet(address(this).balance);
                }
    ...
    function sendETHToLiquiityWallet(uint256 amount) private {
        _liquidityWallet.transfer(amount);
    }
    ...
    function _getTokenFee(address recipient) private view returns (uint256) {
        ...
        if(
            block.timestamp < tradingOpenTime + 2 days &&
            recipient == uniswapV2Pair) {
               return _tokensFeeFirst2Days;
        }
