...
contract BVGARDEN is ERC721Enumerable, Ownable { using Strings for uint256;
...
string memory _initNotRevealedUri
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(_mintAmount > 0, "Mint at least 1 Flower"); require(_mintAmount <= maxMintAmount, "Flower limit exceeded");
        require(supply + _mintAmount <= maxSupply, "All Flowers have been minted"); uint256 userMintedCount = addressMintedBalance[msg.sender]; require(userMintedCount + _mintAmount <= nftPerAddressLimit, "No more flowers for u :)");
        ...
        if (msg.sender != owner()) { 
            ...
            require(whitelistedMintedCount + _mintAmount <= whitelistedPerAddressLimit, "1 whitelisted Flower per address only");
            }
