...
contract DogeDrinks is Context, IERC20Upgradeable {
    ...
    address payable private _marketingWallet = payable(0xA8BD77ad172E7fdfCdF65E28B89E9aF33C147d5a);//ETH Mainnet
    ...
    uint256 private _liqAddStatus = 30000000;
    uint256 private _liqAddBlock = 0;
    uint256 private _liqAddStamp = 0;
    uint256 private _initialLiquidityAmount = 81;
    ...
    function intializeContract() external onlyOwner {
        ...
        _maxTxAmount = (_tTotal * 1) / 10000;
        maxTxAmountUI = (startingSupply * 1) / 10000;
        _maxWalletSize = (_tTotal * 10) / 100;
        maxWalletSizeUI = (startingSupply * 10) / 100;
        swapThreshold = (_tTotal * 15) / 10000;
        swapAmount = (_tTotal * 15) / 10000;
...
//===============================================================================================================
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if(_hasLimits(from, to)) {
            ...
            if (sameBlockActive) {
                if (lpPairs[from]){
                    require(lastTrade[to]+60 <= block.timestamp);
                    lastTrade[to] = block.timestamp;
                } else {
                    require(lastTrade[from]+60 <= block.timestamp);
