...
contract PokiDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmQJh2P8qYmFfZnDhaCuecon7Z3vYLCuYMAb4338Au9ce3";
    ...
    constructor(
    ) ERC721A("PokiDAO", "POKI", 100, maxSupply) {
    }
