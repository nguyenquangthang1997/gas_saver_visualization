...
// File: contracts/GalacticApes.sol
 ...
 */
contract GalacticApes is ERC721Enumerable, Ownable {
    using Strings for uint256;
    using Address for address;
    ...
    constructor(
        ...
        conf = Conf(false, 10, 250, 151, 9999, 80000000000000000);
        defaultURI = _defaultURI;
    }

    /**
     * @notice Mint reserved GalacticApes.
    ...
    /**
     * @notice Bring new Apes into the world.
     * @param amount Number of Apes to mint.
     * @dev Utilize unchecked {} and calldata for gas savings.
     */
    function mint(uint256 amount) public payable {
        require(conf.mintEnabled, "Minting is disabled.");
        require(
            conf.supply + amount < conf.maxApes,
        ...
        require(
            amount <= conf.perMint,
            "Amount exceeds current maximum Apes per mint."
        );
        require(
    ...
    /**
     * @notice Returns max Apes per mint.
     */
