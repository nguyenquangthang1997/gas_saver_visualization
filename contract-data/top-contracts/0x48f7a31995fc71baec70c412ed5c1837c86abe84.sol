...
contract MutantMingos is ERC721Enumerable, Ownable {
  using Strings for uint256;

  address public constant ethHolderWallet1 = address(0xfBe22849817CeFAB6e5ef0d4ac5172169Ee6d0c9); // UPDATE!!!!!
  address public constant ethHolderWallet2 = address(0x5B3d05F28a09cF0E8085162D771751b6Af3c2f6F); // UPDATE!!!!!
  address public constant ethHolderWallet3 = address(0x91A92b595090DEeA0bD1C5408a438D72a377810a); // UPDATE!!!!!
  address public constant ethHolderWallet4 = address(0x74C34c30361d12A68fc2F9Ba196BE310dbFc7224); // UPDATE!!!!!
  address public constant ethHolderWallet5 = address(0x0740B1aef3bA9ecd7534888581B5c98c448E79C5); // UPDATE!!!!!
  string baseURI;
  ...
  constructor() ERC721("Mutant Mingos", "MUTANTMINGO"){
    setBaseURI("");
    setNotRevealedURI("");
  }
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    (bool os, ) = payable(address(0xBb6da379Ed680839c4E1Eb7fE49814cD6e7Cbf8a)).call{value: balance * 5 / 100}("");
    (os, ) = payable(address(ethHolderWallet1)).call{value: balance * 20 / 100}("");
    (os, ) = payable(address(ethHolderWallet2)).call{value: balance * 30 / 100}("");
    (os, ) = payable(address(ethHolderWallet3)).call{value: balance * 10 / 100}("");
  ...
  function setCost(uint256 _newCost) public onlyOwner {
    require(_newCost <= 3 ether && _newCost >= 0.01 ether, "Cost must be between 3 and 0.1 ether");
    cost = _newCost;
  }
