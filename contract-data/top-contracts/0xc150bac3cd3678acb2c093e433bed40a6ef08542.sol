...
contract ShinyToken is ERC20PresetMinterPauser, Ownable {    
    // _amount = 10000000000000000000000000 (mints 10M tokens)
    // _vestingBeneficiary = 0xd5e0f35b1512512A7D14faE94798bD6aa16E0fAc


    uint256 CreatorAmount = 10000000000000000000000000;

    constructor(
        address _vestingBeneficiary
    ) ERC20PresetMinterPauser('Shiny', 'SHINY') {
