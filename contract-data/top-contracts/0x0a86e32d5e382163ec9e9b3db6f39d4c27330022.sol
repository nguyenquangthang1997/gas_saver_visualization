...
contract TheGreatBrainsClub is Ownable, ERC721 {
    uint constant tokenPrice = 0.07 ether;
    uint constant maxSupply = 10000;
    
    uint public totalSupply = 0;
    
    uint public sale_startTime = 1634497200;
    uint public nft_reveal_time = 1634605200;
    ...
    constructor() ERC721("The Great Brains Club", "GBC"){}
   ...
   function buy(uint _count) public payable{
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token");
        if(block.timestamp <= nft_reveal_time){
            return "https://gateway.pinata.cloud/ipfs/Qmc2qBUHHkTH1egg3FaY6qYaeBZ3GkAWkgsecjKjMRWNs2";
        }
    ...
    function update_reveal_time(uint time) external onlyOwner{
        nft_reveal_time = time;
    }
