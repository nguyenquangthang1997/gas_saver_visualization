...
// File: contracts/Ciphersquares.sol
...
contract Ciphersquares is ERC721, Ownable {
    ...
    uint256 public nftPrice = 90000000000000000; //0.09 ETH
    uint public maxNFTPurchase = 20;
    uint256 public MAX_NFT = 3623;
    ...
    constructor() ERC721("Ciphersquares", "CSQR") {
        REVEAL_TIMESTAMP = block.timestamp + 86400;
    }
    ...
    /**
     * Set price to mint a Ciphersquares.
     */
    ...
    */
    function mintNFTs(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_NFT, "Purchase would exceed max supply of NFTs");
