/*
    ...
    Water Tiger  - $WATERTIGER | ERC-20

    2022 is the year of the Water Tiger. The Water Tiger has a strong sense of self-esteem and learning ability

    Experience the full potential of the water tiger.

    Water Tiger Inu is a community driven token which is running on the Ethereum Network. You will not find us on any other network.

    Tokenomics:
    6% Autoadding liquidity, 6% dev/marketingfunds, 1% reflection

    🌐 Website: https://www.watertigerinu.com/

    📞 Telegram: https://t.me/WaterTigerETH

    🐦 Twitter: https://twitter.com/WaterTigerETH
...
contract WATERTIGER is Context, IERC20, Ownable {
    ...
    string private _name = "Water Tiger Inu";
    string private _symbol = "WATERTIGER";
