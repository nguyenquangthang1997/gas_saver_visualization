...
// File: contracts/NobiToadz

pragma solidity >=0.6.0 <0.8.0;

/**
 * @title NobiToadz contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract NobiToadz is ERC721, Ownable, PaymentSplitter {
    ...
    uint256 public tokenPrice = .042 ether;
    
    uint256 public constant maxTokens = 3957;

    uint256 public devTokenCount = 3957;

    string private _contractURI;
    
    uint256 public maxMintsPerTx = 5;
    
    constructor() public ERC721("NobiToadz", "NOBI") {}
    ...
    function totalSupply() public view override returns (uint) {
        return _tokenIdCounter.current() + devTokenCount - 3957;
    }
