...
// File: contracts/CypherCityPets.sol
pragma solidity ^0.8.0;
...
contract CypherCityPets is ERC721Enumerable, Ownable {
    uint256 public constant MAX_NFT_SUPPLY = 8888;
    bool public saleStarted = true;

    mapping(uint256 => bool) public cyphersRedeemed;

    CypherCity cypherCityContract;

    constructor(address cypherCityAddress) ERC721("Cypher City Pets", "PETS") {
        cypherCityContract = CypherCity(cypherCityAddress);
    }

    function _baseURI() internal view virtual override returns (string memory) {
        return "https://api.cyphercity.io/pets/";
    }
   ...
   function mint(uint256[] memory cyphers) public {
