...
contract LonelyHearts is ERC721Enumerable, Ownable {
    ...
    uint256 public constant RESERVED_NFTS = 120;
    address public constant team1Address = 0x1a9908fBdA88Ba74DAdf6c39D9F5C62EdaB770f1;
    address public constant team2Address = 0x0c88f0F125c59cad35c704B8044107F2E51D28Fe;
    address public constant devAddress = 0xADDaF99990b665D8553f08653966fa8995Cc1209;
    address public constant founderAddress = 0xd7e27817D5E19A161A0108eb3abDeD45544d1A0e;
    ...
    constructor(string memory baseURI) ERC721("The Lonely Hearts Club", "LHC") {
    ...
    function withdrawAll() public onlyOwner {
        ...
        _widthdraw(team1Address, ((balance * 8) / 100));
        _widthdraw(team2Address, ((balance * 10) / 100));
