...
contract GenAlcLab is ERC721URIStorage, Ownable{
    ...
    uint256 public totalCount = 3500; //bruhTotal
    uint256 public presaleMax = 688; 
    uint256 public maxBatch = 10; // bruhBatch
    ...
    function mintGenApes(uint256 _times) payable public mintEnabled {
