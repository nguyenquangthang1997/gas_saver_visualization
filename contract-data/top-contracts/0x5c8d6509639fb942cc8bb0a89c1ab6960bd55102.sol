...
import "../utils/orionpool/lib/TransferHelper.sol";
...
contract PoolFunctionality is OrionPoolV2Router02, IPoolFunctionality {
    ...
    function getWETH() external override returns (address) {
        return WETH;
    }
...
library OrionPoolV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'0c591b9bd08f1704b700bd0b662cd000c1bf71b54704b340e7442d09778ed7c7'
                //hex'7b14a91bbf74580dc8673a7301bead18de65fd001bbf7a71d17e9d7ffcd72680'
            ))));
    }
