...
contract FlashDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = "FlashDAO";
    string private constant _symbol = "FlashDAO";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xE1AD20E2DdfD6222a13b6F6A5ccefAF0ea07eca4);
        _feeAddrWallet2 = payable(0x406dE96D3fF6c27FC0a6b6683B24378879672858);
