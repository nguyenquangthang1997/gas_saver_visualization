...
╚═╝░░╚═╝╚═╝╚═╝░░░░░  ╚═╝░░╚═╝░╚════╝░╚═════╝░╚══════╝
 *
 *  Telegram: https://t.me/MambaCoinEth
 *   Website: mambametaversecoin.com
 *    20% sell tax first 12 hours   
 *    10% buy 10% sell 
 *    Mamba Membership to earn Free Kobe NFTs
*/   
...
contract MambaCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "MambaCoin";
    string private constant _symbol = "Mamba";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x5E528550352246aD08B6c7Cb62240213B5f8C848);
        _feeAddrWallet2 = payable(0x5E528550352246aD08B6c7Cb62240213B5f8C848);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isBuy(from)) {
            // TAX SELLERS 20% WHO SELL WITHIN 12 HOURS
            if (_buyMap[from] != 0 &&
