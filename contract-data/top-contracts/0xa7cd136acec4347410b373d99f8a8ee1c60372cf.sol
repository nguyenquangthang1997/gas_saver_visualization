...
contract LockProxyBridge {
    ...
    constructor(address _want, address _xvault, address _lockproxy, address _ccmc, uint64 _toChainId) public {
        want = _want;
        xvault = _xvault;
...
contract LockProxyBridgeWETH is LockProxyBridge {
    constructor(address _xvault)
        public
        LockProxyBridge(
            address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2), // WETH
            _xvault, // 0x46b2e0224efb03d43eba88ab5a1995480e6a76b6 XWETH
            address(0x250e76987d838a75310c34bf422ea9f1AC4Cc906), // Lock Proxy
            address(0x14413419452Aaf089762A0c5e95eD2A13bBC488C),  // ECCM
            14
        )
    {}
}
...
contract LockProxyBridgeWBTC is LockProxyBridge {
    constructor(address _xvault)
        ...
        LockProxyBridge(
            ...
            _xvault, // 0xebd0e8988ac25a793dc27368f96a5a72e34efcd7 XWBTC
            address(0x250e76987d838a75310c34bf422ea9f1AC4Cc906), // Lock Proxy
            address(0x14413419452Aaf089762A0c5e95eD2A13bBC488C),  // ECCM
            14
        )
...
contract LockProxyBridgeUSDT is LockProxyBridge {
    constructor(address _xvault)
        ...
        LockProxyBridge(
            ...
            _xvault, // 0xa93727e8661d4f82cfd50f7d8fd3f38ec8493b84 XUSDT
            address(0x250e76987d838a75310c34bf422ea9f1AC4Cc906), // Lock Proxy
            address(0x14413419452Aaf089762A0c5e95eD2A13bBC488C),  // ECCM
            14
        )
