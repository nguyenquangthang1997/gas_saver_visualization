...
// File: contracts/ValkyraeDAO.sol
...
contract ValkyraeDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmVgp4fbV3m2D3V6NGbZZToGP5RNcdyCfWxeCACwSEuE6R";
    ...
    constructor(
    ) ERC721A("ValkyraeDAO", "VDAO", 100, maxSupply) {
    }
