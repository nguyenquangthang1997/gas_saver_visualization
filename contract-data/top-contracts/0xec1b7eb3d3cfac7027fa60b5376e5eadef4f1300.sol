...
// HZMCOIN Token contract based on the full ERC 20 Token standard
// Symbol: HZM
// Status: ERC20 Verified

contract HZMCOINToken { 
...
/**
 * HZMCOIN Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract HZMStandardToken is HZMCOINToken, Ownable {
    
    using HZMMaths for uint256;
...
contract HZMCOIN is HZMStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 10 * (10**10) * 10**8 ; // 100 billion tokens, 8 decimal places
