...
contract BabyShibnobi is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0x1DC23145c3A75f3Ce7224c091c92a32b4db85e91); // Marketing Wallet
    address payable private devWallet = payable (0xdf8e67b3473c041Cfa0Fc0FCC55aE0D9083c85d8); // dev Wallet
    ...
    string private _name = "Baby Shibnobi";
    ...
    function disableAntiBotmode() external onlyOwner() {
       ...
       IERC20(address(this)).transfer(DEAD, balance.mul(9).div(10)); //send 90% to dead address
    }
