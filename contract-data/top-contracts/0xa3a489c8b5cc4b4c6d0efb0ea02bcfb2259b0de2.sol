...
contract BellaDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmYt1M3PS4mkM3kf5VUAgHgqpKvAdQUfVqKxrtjhArKJRe/";
    ...
    constructor(
    ) ERC721A("BellaDAO", "BELLA", 100, maxSupply) {
    }
