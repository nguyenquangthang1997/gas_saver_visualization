...
contract SympathyForTheDevils is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    constructor(string memory name, string memory symbol, uint256 maxDevilSupply) ERC721(name, symbol) {
        maxTokenSupply = maxDevilSupply;

        _shareholders[0] = 0x72e20c7dcf9dCE371f816e73d5FcEAa43f6a3094;
        _shareholders[1] = 0xDc8Eb8d2D1babD956136b57B0B9F49b433c019e3;
        _shareholders[2] = 0xD934f8Cd9f3d9caDA39b9714206877b308EF071f;
    ...
    */
    function mintDevils(uint256 numberOfTokens) public payable {
        ...
        require(numberOfTokens <= MAX_MINTS_PER_TXN, "You can only mint 16 devils at a time");
        require(totalSupply() + numberOfTokens <= maxTokenSupply, "Purchase would exceed max available devils");
    ...
    */
    ...
    function cookDevil(uint256 firstTokenId, uint256 secondTokenId) public {
        require(cookingIsActive && !saleIsActive, "Either sale is currently active or cooking is inactive");
