/*
 ...
 _______  __   __  ___      ___      _______  _______  __   __ 
|  _    ||  | |  ||   |    |   |    |       ||       ||  | |  |
| |_|   ||  | |  ||   |    |   |    |    ___||_     _||  |_|  |
|       ||  |_|  ||   |    |   |    |   |___   |   |  |       |
|  _   | |       ||   |___ |   |___ |    ___|  |   |  |       |
| |_|   ||       ||       ||       ||   |___   |   |  |   _   |
|_______||_______||_______||_______||_______|  |___|  |__| |__

The first NFT-based weapon skins platform. Buy, sell and collect unique NFT weapon skins, trade the Bulleth ERC-20 token and join our growing community.

Taxes
- 5% Marketing
- 5% Development
- 2% Buybacks
- Taxes will be gradually lowered
- Locked Liquidity

Useful links
- t.me/bulletherc
- www.bulleth.org
- twitter.com/bullethnft
- opensea.com/bulleth
...
contract BULLETH is Context, IERC20, Ownable {
    ...
    //
    string private _name = "BULLETH";                                           // name
    string private _symbol = "BULLETH";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x15bbb2E61814d3Eb709Bbe05202A66AeEa2022ee);
