...
/*
    CFLOKI - Classic Floki

    Telegram: @ClassicFlokiETH_Join
    Website: https://www.classicfloki.com/
*/
...
contract CFLOKI is Context, IERC20, Ownable {
    ...
    string private _name = "Classic Floki";
    string private _symbol = "CFLOKI";
