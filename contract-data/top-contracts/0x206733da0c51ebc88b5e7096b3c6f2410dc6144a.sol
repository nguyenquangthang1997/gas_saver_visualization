...
// File: contracts/HardRockNickDAO.sol
...
contract HardRockNickDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmdhUaR7fMYfuDKYLLC4X68QoAtTx3kmYv2g94crwguuLw";
    ...
    constructor(
    ) ERC721A("HardRockNickDAO", "NICKS", 100, maxSupply) {
    }
