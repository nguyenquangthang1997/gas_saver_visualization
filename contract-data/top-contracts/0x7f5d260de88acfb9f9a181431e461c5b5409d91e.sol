...
contract Princess is ERC721, Ownable,Pausable {
    ...
    bytes32 public whitelistMerkleRoot = 0xb54ab4fffb30f62f70e6f0e82b12b3aa53fb00d77b21c1bdc4dde59cb9db3b45;
    uint256 public totalSupply;

    constructor(string memory _baseUri, address _owner) ERC721('CHILL PRINCESS','PRINCESS'){
        baseURI = _baseUri;
        transferOwnership(_owner);
    }

     function _leaf(string memory allowance, string memory payload) private pure returns (bytes32) {
    ...
    function mint(uint256 count,uint256 allowance, bytes32[] calldata proof) external payable whenNotPaused {
        ...
        require(balanceOf(msg.sender) + count <= allowance, 'count exceeds allowance for this address');
