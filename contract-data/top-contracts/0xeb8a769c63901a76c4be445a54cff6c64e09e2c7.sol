...
contract SydneySweeneyDAO is ERC721Delegated, ReentrancyGuard {
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 0.015 ETH per item"
    );
  ...
  address private constant payoutAddress1 =
    0x8f04dE1182CdE504A8e6157eab69253F23677A3E;
