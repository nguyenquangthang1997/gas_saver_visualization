...
// SSFV2Maker is MasterChef's left hand and kinda a wizard. He can cook up Sushi from pretty much anything!
// This contract handles "serving up" rewards for xSushi holders by trading tokens collected from fees for Sushi.

// T1 - T4: OK
contract SSFV2Maker is Ownable {
    ...
    modifier onlyEOA() {
        ...
        require(msg.sender == tx.origin, "SSFV2Maker: must use EOA");
        _;
    }
    ...
    function _convert(address token0, address token1) internal {
        ...
        require(address(pair) != address(0), "SSFV2Maker: Invalid pair");
        // balanceOf: S1 - S4: OK
        // transfer: X1 - X5: OK
    ...
    function _swap(
        ...
        require(address(pair) != address(0), "SSFV2Maker: Cannot convert");
...
contract SSFV2Router is IUniswapV2Router02 {
...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'bf1be2afa026f4183762095beb4bf2bca6371c288dbff4de62defb151a78a367' // init code hash
            ))));
    }
...
contract UniswapV2ERC20 {
    ...
    string public constant name = 'SSF V2';
    string public constant symbol = 'SSF V2';
...
contract SSFV2Factory is IUniswapV2Factory {
...
import "../SSFV2Maker.sol";

contract SSFV2MakerExploitMock {
    SSFV2Maker public immutable ssfV2Maker;
    constructor (address _ssfV2Maker) public{
        ssfV2Maker = SSFV2Maker(_ssfV2Maker);
    } 
    function convert(address token0, address token1) external {
        ssfV2Maker.convert(token0, token1);
    }
}