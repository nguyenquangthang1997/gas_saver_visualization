...
contract MintDiscOne is ERC721, ERC721URIStorage, Ownable {
    constructor() ERC721("MintdiscOne", "MD1") {}
    ...
    function airdropToken(address[] memory to) public onlyOwner {
        for(uint256 i = 0; i < to.length; i++) {
            ...
            _setTokenURI(tokenId, "ipfs://QmQbsD8FwU5rr5Yys79vu4w5xUSTExokKqwZ5GR9F4g5j5");
            tokenId = tokenId + 1;
        }
