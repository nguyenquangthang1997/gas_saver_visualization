...
contract ElonsArmy is Context, IERC20, Ownable {
    ...
    constructor() {
        _feeAddrMarketing = payable(0x55c44530cb7b6D83Caf08Dc0F37A1c03a2E56ec0);
        ...
        _feeAddrGameRewards = payable(
            0x4F53835d0f75194eA8A8cD1Ac7395f6Bc54DD9C8
        );

        _administratorAddress = address(0x7A693766ee2F2BD05d023d4Ab27B7faBBDA52a68);
