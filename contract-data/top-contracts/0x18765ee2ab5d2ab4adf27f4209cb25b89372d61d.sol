...
// File contracts/BossyBears.sol


pragma solidity >0.6.1 <0.7.0;
contract BossyBears is ERC721, Ownable, ReentrancyGuard {
    
    using SafeMath for uint256;
    using Address for address;
    using Strings for uint256;
    
    string public constant PROVENANCE = ""; // Change Provenance
    uint256 public constant MAX_SUPPLY = 11111;
    uint256 public constant MAX_RESERVE = 611;
    uint256 public reserveRemain;    
    uint256 public bearPrice;
    ...
    constructor() public ERC721("BossyBearClub", "BBC") {
        isActive = false;
        isPreMintActive = false;
        reserveRemain = MAX_RESERVE;
        bearPrice = 0.045 ether;
    }
    ...
    function mint(uint256 qty) public payable nonReentrant {
        ...
        require(msg.value >= bearPrice.mul(qty), "Insufficient ether for minting.");
    ...
    */
    ...
    function setBearPrice(uint256 price) external onlyOwner {
        bearPrice = price;
    }
