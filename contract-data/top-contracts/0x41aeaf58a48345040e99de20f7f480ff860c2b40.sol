...
import "@openzeppelin/contracts-upgradeable-solc-8/token/ERC721/extensions/ERC721BurnableUpgradeable.sol";
...
import "./interfaces/solc8/ITokenCreatorPaymentAddress.sol";
import "./interfaces/solc8/IGetFees.sol";

import "./libraries/solc8/AccountMigration.sol";
import "./libraries/solc8/ProxyCall.sol";
import "./libraries/solc8/BytesLibrary.sol";
...
{
  using AccountMigration for address;
