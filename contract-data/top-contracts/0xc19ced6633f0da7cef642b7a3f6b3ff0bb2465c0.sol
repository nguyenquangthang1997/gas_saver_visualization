...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    uint256 private constant maxNfts = 5025;
    ...
    function _safeMint(
        ...
        require(currentIndex.add(quantity) <= maxNfts, "The number you're trying to buy exceeds the remaining supply!");
        require(tokenPrice.mul(quantity) <= msg.value, "You didn't include enough ETH with your transaction");
