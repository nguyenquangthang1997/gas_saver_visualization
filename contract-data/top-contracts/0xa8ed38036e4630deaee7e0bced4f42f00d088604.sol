...
contract Canine is Ownable, ERC165, ERC721 {
    // Libraries
    ...
    uint256 public burnPrice = 0.02 ether;
    ...
    constructor() ERC721("Canine Country Club", "CANINE") {
        _setBaseURI(
            "https://us-central1-canine-country-club-5838e.cloudfunctions.net/app/v1/"
        );
    }
    ...
    function breed(uint256 id1, uint256 id2) public payable {
      require(breedingEnabled, "Breeding is not enabled yet.");
      require(msg.value >= burnPrice, "Not enough ETH to breed.");
      _burn(id1);
      _burn(id2);
      _mintInternal(msg.sender);
    }
    ...
    function setBreeding(bool breed) public onlyOwner {
      breedingEnabled = breed;
    }
    ...
    function setBurnPrice(uint256 price) public onlyOwner {
      burnPrice = price;
    }
