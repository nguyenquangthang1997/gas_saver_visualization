...
//Thanks to WKM and Pixel Doods for the open source contract.
contract DoggiesNFT is Ownable, ERC721 {
    ...
    constructor(address proxyRegistryAddress) ERC721("Doggies NFT", "DGGY") {
