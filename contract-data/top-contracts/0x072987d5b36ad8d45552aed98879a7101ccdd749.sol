...
contract BUNNYVERSE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x84e187CF487c6A4C4DA3373678bc272A987BD7B4); // Marketing Address

    address payable public liquidityAddress =
        payable(0x84e187CF487c6A4C4DA3373678bc272A987BD7B4); // Liquidity Address
    ...
    string private constant _name = "BunnyVerse";
    string private constant _symbol = "BNV";
    ...
    constructor() {
        ...
        marketingAddress = payable(0x84e187CF487c6A4C4DA3373678bc272A987BD7B4); // update to marketing address
        liquidityAddress = payable(0x84e187CF487c6A4C4DA3373678bc272A987BD7B4); // update to a liquidity wallet if you don't want to burn LP tokens generated by the contract.
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee <= 15, "Must keep taxes below 15%");
    }
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee <= 25, "Must keep taxes below 25%");
    }
