...
contract CorinnaDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmatUsTv3gfFyaFZBtF4uEA3a7G3LYyjydDqCd86cxjg1w";
    ...
    uint256 public NUM_FREE_MINTS = 388;
    ...
    constructor(
    ) ERC721A("CorinnaDAO", "CRNA", 100, maxSupply) {
    }
