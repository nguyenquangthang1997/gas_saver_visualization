...
contract CryptoCastles is ERC721, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://gateway.pinata.cloud/ipfs/QmSW4WmvAdaJWfWxMb6wG41VHK1RRmHp5TgZ1pwPoKaGcU";
    ...
    constructor(
    ) ERC721("CryptoCastles", "CryptoCastles") {
    }
