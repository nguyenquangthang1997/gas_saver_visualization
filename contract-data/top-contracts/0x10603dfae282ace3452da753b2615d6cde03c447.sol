...
contract Chubbamon721 is ERC721, Ownable {
    ...
    //Inventory
    uint16 public maxMintAmountPerTransaction = 6;
    uint16 public maxMintAmountPerWallet = 10;
    uint16 public maxMintAmountPerWhitelist = 6;
    ...
    constructor(string memory _baseUrl) ERC721("Chubbamon", "CHUBS") {
        baseURI = _baseUrl;
