...
contract LuckyGnomes is ERC721, ERC721Enumerable, Ownable
{
    using Strings for string;

    uint public MAX_TOKENS = 7777;
    uint public limitPerWallet = 3;
    uint public limitPerTransaction = 3;

    uint public constant NUMBER_RESERVED_TOKENS = 50;
    uint256 public constant PRICE = 77700000000000000; //0.0777 ETH
    ...
    address payable private recipient1 = payable(0x7ea9114092eC4379FFdf51bA6B72C71265F33e96);

    constructor() ERC721("Lucky Gnomes", "Gnome") {}
    ...
    function withdraw() external
    {
        ...
        uint part = address(this).balance / 100 * 20;
