...
contract KUNOICHIX is Context, IERC20, Ownable {
    ...
    address private _owner = 0x32781F8F29D7eBFdeF537CA66C115f92BEdAFaD5;
    ...
    string private constant _name = "KunoichiX";
    string private constant _symbol = "KUNO";
    ...
    constructor() payable {
        ...
        maxTransactionAmount = _tTotal * 9 / 1000; // 0.9% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 14 / 1000; // 1.4% maxWalletAmount
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0xcc5e6a8d260f09bA9109Dc61Ff882415B9C66239); // Marketing Address
        
        devAddress = payable(0xcc5e6a8d260f09bA9109Dc61Ff882415B9C66239); // Dev Address
