 ...
 * {ERC721Enumerable}.
 */
contract OptimizedERC721Enumerable is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = OptimizedERC721Enumerable.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(OptimizedERC721Enumerable.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(OptimizedERC721Enumerable.ownerOf(tokenId), to, tokenId);
    }
