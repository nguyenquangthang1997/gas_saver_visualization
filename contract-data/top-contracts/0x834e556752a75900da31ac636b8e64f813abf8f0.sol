...
/** 
 * LASSIE INU MYSTERY GAMING TOKEN
 * 
...
contract LASSIEINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "LASSIE INU";
    string private constant _symbol = "LASSIE";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xed15DE624C530F33dad527B985d8B069bCfe5149);
        _feeAddrWallet2 = payable(0xed15DE624C530F33dad527B985d8B069bCfe5149);
