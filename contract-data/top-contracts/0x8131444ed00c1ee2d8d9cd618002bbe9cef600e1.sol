...
contract CryptoKittenNFT is ERC721Enumerable, Ownable, ERC721Burnable {
    ...
    constructor(string memory baseURI) ERC721("CryptoKittenNFT", "CKN") {
        setBaseURI(baseURI);
        pause(false);
    }
