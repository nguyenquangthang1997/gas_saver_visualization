...
/** 
 * HAYFEVER: PROMOTIONAL GAMING PLATFORM FOR CRYPTO
 * 
...
contract HAYFEVER is Context, IERC20, Ownable {
    ...
    string private constant _name = "HAYFEVER";
    string private constant _symbol = "HAY";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xf5e444A954E1691ACA6c07198da10e3eD2b7EA3D);
        _feeAddrWallet2 = payable(0xFAb12Ce8daEad18BE26f9d326dDBACFc36D857C9);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isBuy(from)) {
            // TAX SELLERS 12% WHO SELL WITHIN 24 HOURS
            if (_buyMap[from] != 0 &&
