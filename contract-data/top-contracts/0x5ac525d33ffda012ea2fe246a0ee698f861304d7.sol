...
contract MetaverseCapital is Context, IERC20, Ownable {
    ...
    address payable public treasuryAddress = payable(0x89465e5552bFda9b8482e582ed497aA02aA8CEb7); // Treasury Address

    address payable public liquidityAddress =
        payable(0x69f671B159De297358e900e983caA3CB1C2aE019); // Liquidity Address
                
    address payable public devAddress =
        payable(0x69f671B159De297358e900e983caA3CB1C2aE019); // Buyback Address
    ...
    uint256 private gasPriceLimit = 200 * 1 gwei;
