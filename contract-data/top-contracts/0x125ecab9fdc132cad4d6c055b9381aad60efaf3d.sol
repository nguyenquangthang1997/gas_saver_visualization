...
contract MonsterMobs is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public constant MAX_ITEMS = 7777;
    uint256 public constant MAX_PRESALE_ITEMS = 777;
    ...
    uint256 public constant MAX_MINT_PRESALE = 7;
    address public constant creatorAddress = 0x3587471Eca4f5A0c26E3771a3790296FD32e5612;
    address public constant artistAddress = 0xf1B943A3E25db879C1BE6AFc15145Ade18402BFF;
    address public constant devAddress = 0xc4F2F2fcDe383EB86b697422fDdD46FeD89579D7;
    ...
    event CreateMonster(uint256 indexed id);
    event AttributeChanged(uint256 indexed _tokenId, string _key, string _value);

    constructor(string memory baseURI) ERC721("MONSTER MOBS", "MONSTERMOBS") {
        setBaseURI(baseURI);
        pause(true);
        presale = false;
        sale = false;
    ...
    */
    ...
    function changeAttribute(uint256 tokenId, string memory key, string memory value) public payable {
        ...
        require(_msgSender() == owner, "This is not your Monster.");
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        require(balance > 0);
        _widthdraw(devAddress, balance.mul(30).div(100));
        _widthdraw(artistAddress, balance.mul(35).div(100));
