...
contract FXGoat is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbhpjrMpS2WtgPzUkb33hPnXiU7dPxbSdxi1Q5SRYQ3AY";
    ...
    constructor(
    ) ERC721A("FXGoat", "FXGoat", 100, maxSupply) {
    }
