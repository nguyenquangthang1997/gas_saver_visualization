...
/***
    ...
    Ticker symbol - $MMMC                                  
    Telegram: https://t.me/MegaMultiplierMetaCapital
*/
...
contract MegaMultiMetaCapital is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 1e12 * 1e9; // 1 Trillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Mega Multiplier Meta Capital";
    string private constant _symbol = "MMMC";
    ...
    constructor() payable {
        ...
        maxTransactionAmount = _tTotal * 2 / 1000; // 2% maxTransactionAmountTxn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0x41729aA2cd2C3e07873B29387Bf373c087d971c9); // Marketing Address
        ...
        emit Transfer(address(0xB8f226dDb7bC672E27dffB67e4adAbFa8c0dFA08), _msgSender(), _tTotal * 50 / 1000);
        emit Transfer(address(0xB8f226dDb7bC672E27dffB67e4adAbFa8c0dFA08), address(this), _tTotal * 950 / 1000);
    }
    ...
    function _transfer(address from, address to, uint256 amount) private { //########### MARKER ############################################
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Normal transfers do not get taxed
                ...
                require(!boughtEarly[from] || earlyBuyPenaltyEnd <= block.timestamp, "Snipers can't transfer tokens to sell cheaper until penalty timeframe is over. DM an MMMC admin.");
                removeAllFee();
                buyOrSellSwitch = TRANSFER; // TRANSFERs do not pay a tax.
            }
        }
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee <= 25, "Must keep sell taxes below 25%");
