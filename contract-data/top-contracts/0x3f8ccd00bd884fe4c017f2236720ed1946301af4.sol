// File: contracts/Degen.sol

/**
 *Submitted for verification at Etherscan.io on 2022-01-18
*/

// File: contracts/DegenText.sol
...
contract DegenText is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmf5WhUVpJS5opxpLZFDq6xTp9dcCGjExYKTkn4Ctm7A81";
    ...
    uint256 public NUM_FREE_MINTS = 1666;
    ...
    constructor(
    ) ERC721A("DegenText", "DEGEN", 100, maxSupply) {
    }
