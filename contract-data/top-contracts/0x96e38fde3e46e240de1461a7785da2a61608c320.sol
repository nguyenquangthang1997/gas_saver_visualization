...
/**
 * Zoo Gang powered by Kollectiff
 * https://zoogangnft.io
 */
...
contract ZooGang is ERC721Enumerable, Ownable {
    ...
    /**
     * Set some Zoo Gang aside
     */
    function reserve() public onlyOwner {     
        require(saleIsActive == false, "Impossible reserve a Zoo Gang when sale is active");   
    ...
    */
    function mint(uint256 numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_TOKENS, "Purchase would exceed max supply of Zoo Gangs");
