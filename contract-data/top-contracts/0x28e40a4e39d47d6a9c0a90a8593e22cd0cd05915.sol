...
contract CryptoTrolls is ERC721, Ownable {

    using SafeMath for uint256;

    string public TROLL_ORIGIN = "";

    uint256 public constant MAX_TOKENS = 7331;
    ...
    constructor() ERC721("The Crypto Trolls", "TROLL") {}

    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
        TROLL_ORIGIN = _provenanceHash;
    }
