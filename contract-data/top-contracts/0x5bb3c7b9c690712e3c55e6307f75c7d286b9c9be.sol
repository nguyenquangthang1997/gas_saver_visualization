...
/**
	...
	Telegram: https://t.me/muskrafttoken
...
contract MuskRaft is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Muskraft";//
    string private constant _symbol = "MRAFT";//
    ...
    address payable private _developmentAddress = payable(0x867D43679b43752299767365bBFabcA77856405C);//
    address payable private _marketingAddress = payable(0x03dCC67aebB68B84bA74beeC1aBD58a7376D5BFe);//
    ...
    uint256 public _maxTxAmount = 15500000 * 10**9; //
    uint256 public _maxWalletSize = 51000000 * 10**9; //
