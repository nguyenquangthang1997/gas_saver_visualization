 ...
 * 
 */
abstract contract ERC721EnumerableAlt is ERC721Alt, IERC721Enumerable {
    
    /**
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, ERC721Alt) returns (bool) {
     ...
     * Altered to use the ERC721Alt _owners array instead of _allTokens
     */
     ...
     * Altered to use ERC721Alt _owners array instead of _allTokens
     */
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < ERC721EnumerableAlt.totalSupply(), "ERC721Enumerable: global index out of bounds");
        return index;
    }
 ...
 */
contract ERC721Alt is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // Array of token ID to owner address, set to internal to give {ERC721EnumerableAlt} access
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ERC721Alt.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(ERC721Alt.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ERC721Alt.ownerOf(tokenId), to, tokenId);
    }
