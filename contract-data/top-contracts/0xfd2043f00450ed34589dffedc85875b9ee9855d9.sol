 ...
 * {ERC721Enumerable}.
 * @notice This implementation has been heavily optimised for gas efficiency by:
 * @author @MilkyTasteEth MilkyTaste:8662 https://milkytaste.xyz
 */
contract ERC721Optimised is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function balanceOf(address owner) external view virtual override returns (uint256) {
        // Overridden in child.
        revert("ERC721Optimised: Must be overridden in child");
    }
