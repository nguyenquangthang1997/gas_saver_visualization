...
contract SipherNFT is ERC721, ERC721Enumerable, Pausable, ERC721Burnable, Ownable, ISipherNFT {
  // only allow genesis minter to mint at most 10K NFT
  ...
  event mintRecord(uint256 ID, uint256 amount, address to, uint256 unitPrice);
   ...
   */
  function mintGenesis(uint256 amount, address to, uint256 unitPrice ) external override onlyGenesisMinter {
    ...
    emit mintRecord(startId, amount, to, unitPrice);
  }
