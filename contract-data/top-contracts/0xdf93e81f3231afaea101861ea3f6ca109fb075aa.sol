...
// File: contracts/BabyDinosNFTToken.sol
...
contract BabyDinosNFTToken is ERC721Enumerable, Ownable, Royalties, MinterRole {
    using Strings for uint256;
    using SafeMath for uint256;

    string public baseExtension = ".json";
    string public baseURI = "https://thumbnail-egg-collections.s3.us-east-2.amazonaws.com/";
    ...
    function mint(
        ...
        require(_mintAmount > 0, "BabyDinosNFTToken: mintAmount should be > 0");
        ...
        returns (string memory)
    {
        require(
            _exists(tokenId),
            "BabyDinosNFTToken: URI query for nonexistent token"
        );
