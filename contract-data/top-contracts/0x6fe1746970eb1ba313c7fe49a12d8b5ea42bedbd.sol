/*
            ...
            XÆA-Xii Token - XÆA-Xii

            Telegram: https://t.me/XAEAXiiToken
            Twitter: https://twitter.com/xaeaxiitoken
            Website: https://sonofelontoken.com/
...
contract XAEAXii is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0x49f5F03838159b9250091B2F7eeB76Ec87937C84);
    ...
    constructor() ERC20("XAEA-Xii Token", "XAEA-Xii") {
        ...
        uint256 totalSupply = 1 * 1e17 * 1e18;
 
        maxTransactionAmount = totalSupply * 2 / 100; // 0.2% maxTransactionAmountTxn
        maxWallet = totalSupply * 6 / 100; // .6% maxWallet
