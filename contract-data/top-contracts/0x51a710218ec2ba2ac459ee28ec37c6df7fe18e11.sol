...
contract StakingRewardsWbtc is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function satoshiToWei(uint256 amount) public pure returns (uint256) {
