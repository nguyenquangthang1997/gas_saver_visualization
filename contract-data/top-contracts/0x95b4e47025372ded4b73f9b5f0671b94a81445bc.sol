...
contract InfinityGaming is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xAa6242ec31AC72CC5929a3939ACA7c38d73906e7));
    address payable public _devwallet =
        payable(address(0xF834fF81B492615E4d0Cd5Cf4B6089F8A0E4222c));
    address public _exchangewallet =
        payable(address(0x9448Bc5e6D09270d8E31e24991B3941Ea88d9604));
    address _partnershipswallet =
        payable(address(0x3fcaC6ecC2d0365EDD177a3F34a460d9266E6C50));
    ...
    uint256 public _maxWalletSize = 15000 * 10**6 * 10**9;
