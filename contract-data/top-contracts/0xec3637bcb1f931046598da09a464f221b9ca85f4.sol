...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a POW shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract POWDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "POW DAO";
    ...
    address payable public marketingWallet = payable(0x806483684087Ec2DeDE2894AF1ed6DD0925a99F9);
    address payable public treasury = payable(0x806483684087Ec2DeDE2894AF1ed6DD0925a99F9);
    ...
    uint256 private maxBuy = 200 * (10 ** _decimals);
    ...
    constructor (    ) Auth(0x295425BD886c807Dd3CF8dc55c1F873f3e27e186) {
        address _owner = 0x295425BD886c807Dd3CF8dc55c1F873f3e27e186;
