...
contract FLOKITAMA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x5e2D9037Fd0f28720A80f6c799DAb33348edbe1D); // Marketing Address
    ...
    string private constant _name = "FLOKITAMA";
    string private constant _symbol = "FLOKITAMA";
    ...
    constructor() {
        ...
        marketingAddress = payable(0x5e2D9037Fd0f28720A80f6c799DAb33348edbe1D); //  update to marketing address
