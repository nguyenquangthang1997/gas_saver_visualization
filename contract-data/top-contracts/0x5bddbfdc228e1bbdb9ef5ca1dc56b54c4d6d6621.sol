...
contract Inuyasha is Context, IERC20, Ownable {
    ...
    string private _name = "Inuyasha";
    string private _symbol = "Inuyasha";
    ...
    uint256 public buyBackFeeDivisor = 2;
    ...
    address public marketingWallet = 0x3a0aB80324B676d0573a41Da6374af827Dc49abE;
...
uint256 rLiquidity = tLiquidity.mul(currentRate);
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && from != uniswapV2Pair && swapAndLiquifyEnabled) {
            if(overMinTokenBalance) {
                // swap for buyback and liquidity
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 buybackShare = contractTokenBalance.mul(buyBackFeeDivisor).div(_liquidityFee);
        uint256 LiquidityShare = contractTokenBalance.sub(buybackShare);
        // swap buybackShare
        if(buyBackFeeDivisor > 0) {
