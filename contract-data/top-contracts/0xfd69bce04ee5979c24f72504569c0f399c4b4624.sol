...
// @author: TropicalTurtles Team
contract TropicalTurtles is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public PRICE = 35E15; // 0.025 ETH
    ...
    address public constant creatorAddress = 0xcd4E08C8d34DD8561020b05CE98A623a2751c115;
    address public constant devAddress = 0x9937B1Dbb83F5Bd57Cc5F04Abe4a332732e7573a;

    event CreateTurtle(uint256 indexed id);
    event AttributeChanged(uint256 indexed _tokenId, string _key, string _value);

    constructor(string memory baseURI) ERC721("Tropical Turtles", "TropicalTurtles") {
        setBaseURI(baseURI);
        pause(true);
        presale = false;
        sale = false;
    ...
    */
    ...
    function changeAttribute(uint256 tokenId, string memory key, string memory value) public payable {
        address owner = ERC721.ownerOf(tokenId);
        require(_msgSender() == owner, "This is not your Turtle.");
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        require(balance > 0);
        _widthdraw(devAddress, balance.mul(225).div(1000));
