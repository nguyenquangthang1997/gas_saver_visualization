...
contract ShiryoinuChef is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 public quantumStakedTokens = 20000000000000000000000; // number of staked tokens needed to earn the reward, 20 trillion x 9 decimals
   ...
   // uint256 rewardDuration = 7 days;
    ...
    constructor(){
        rewardToken = IERC20(0x773D6E3e85Ed29D2C40C42f7cbc8aD3d4dDBeef0);
        stakedToken = IERC20(0x1E2F15302B90EddE696593607b6bD444B64e8F02);
        stakedLP = IERC20(0xe6e1F4F9b0303Ca3878A110061C0Ec9b84fddD03);
    }
