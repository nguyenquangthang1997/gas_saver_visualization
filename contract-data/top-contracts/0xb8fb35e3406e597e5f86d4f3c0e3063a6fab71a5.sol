...
contract AnySniper is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x960E8ec2b53505bD6751e7673e1d44E5ec33E57a); // Marketing Address
    address payable public rewardAddress = payable(0x960E8ec2b53505bD6751e7673e1d44E5ec33E57a); // Reward Address
    address payable public liquidityAddress = payable(0x960E8ec2b53505bD6751e7673e1d44E5ec33E57a); // Liquidity Address
    ...
    string private constant _name = "AnySniper";
    string private constant _symbol = "SNIPE";
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
            ...
            // If sniper buy or sell, increase marketing fee
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyRewardFee + _buyMarketingFee <= 15, "Must keep taxes below 15%");
    }
