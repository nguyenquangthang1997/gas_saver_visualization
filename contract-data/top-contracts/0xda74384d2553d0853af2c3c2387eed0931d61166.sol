...
contract McDonalsInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 690000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet = payable(0x094C2a7728CbAd24b243928c63D1d1DC8acaAe8c);

    string private _name = "McDonals Inu";
    string private _symbol = "McDNLDS";
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 690, "Max Tx Amount cannot be less than 69 Million");
        _maxTxAmount = maxTxAmount * 10**9;
    }

    function upliftTxAmount() external onlyOwner() {
        _maxTxAmount = 690000 * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 690, "Swap Threshold Amount cannot be less than 69 Million");
