...
contract PokerNFT is IVoiceStreetNft, Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    constructor()
    {
        _name = "PokerNFT";
        _symbol = "PokerNFT";
        setBaseURI("http://api.pokernft.site/index.php?id=");
    }
