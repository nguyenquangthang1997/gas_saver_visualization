...
// Twitter: https://twitter.com/wunksnft
// Discord: https://discord.gg/WFYrEeT6Y9
// Website: https://wunks.xyz
...
contract Wunks is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  uint                        public constant MAX_TXN_WUNK_PURCHASE = 11;
  uint256                     public constant MAX_WUNKS = 5109;
  uint256                     public constant MAX_FREE_PER_USER_WUNKS = 6;
  uint256                     public constant FREE_WUNKS = 533;
  // 6000 TOTAL SUPPLY. 924 TOTAL airdrops. 33 airdrops upfront. = 5109
    
  constructor() ERC721("WunksV2", "WUNKSV2") {
  ...
  function mintToken(uint numberOfTokens) public payable nonReentrant {
    ...
    require(numberOfTokens < MAX_TXN_WUNK_PURCHASE, "You can only mint 10 Wunks per transaction.");
    require(totalSupply().add(numberOfTokens) < MAX_WUNKS, "Purchase would exceed max supply");
