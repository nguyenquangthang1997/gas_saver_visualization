...
contract FeudalzAnimalz is ERC721, EIP712, ERC721Burnable, AccessControl {
    ...
    constructor() ERC721("Feudalz Animalz", "Animalz") EIP712("ANIMALZ", "1.0.0") {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setupRole(ADMIN_ROLE, msg.sender);
        _signerAddress = 0x42bC5465F5b5D4BAa633550e205A1d7D81e6cACf;
        _contractUri = "ipfs://Qmc9EtSB2ZdZmb8qfscNr7E4oH5GSCK4xeKKP61GAizte1";
        _baseUri = "https://api.feudalz.io/animalz/";
    }
