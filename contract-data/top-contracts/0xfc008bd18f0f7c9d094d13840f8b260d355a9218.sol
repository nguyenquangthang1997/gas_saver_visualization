...
/**
 ...
 Fair Launch ETH.
 $25K Starting Liquidity 
 1 Trillion Supply
 15% Slippage Minimum
 10% tax per sell transaction
 5% tax per buy transaction
...
contract CoffeeToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Coffee";
    string private constant _symbol = "CUP";
    ...
    address payable private _marketingAddress = payable(0xbE18091D482a40ef5D89A38A80ecD34B11540544);
    address payable private _devAddress = payable(0xfE158939F504d94CdC2E3485373Ee76299A8C4ca);
