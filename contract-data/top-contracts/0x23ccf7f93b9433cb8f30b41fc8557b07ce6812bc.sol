...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < numOwners(), "ERC721Enumerable: global index out of bounds");
        return index;
    }
...
abstract contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     * @dev seed _owners with null entry to make 1-based token
     * id lookups simpler. Either manipulate length or indices. 
     */
    ...
    function numOwners() internal view returns (uint256) {
    ...
    function _exists(uint256 tokenId) internal view virtual returns (bool) {
        return tokenId <= numOwners() && _owners[tokenId] != address(0);
    }
